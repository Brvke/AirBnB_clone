...
class Test_User(unittest.TestCase):
    """ checks certain aspects of User Class"""
    def test_equal(self):
        """ checks the sucess cases of User """
        test_object = User()
        self.assertIsInstance(test_object, User)
        time.sleep(1)
        test_object.name = "My_First_Model"
        test_object2 = User(**test_object.to_dict())
    ...
    def test_print(self):
        ...
        test_str = f"[User] ({test_object.id}) {test_object.__dict__}"
        self.maxDiff = None
